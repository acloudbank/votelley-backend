...
class Poll
{
  public:
     ...
     */
    explicit Poll(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;
     ...
     */
    Poll(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
