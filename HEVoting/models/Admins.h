...
class Admins
{
  public:
     ...
     */
    explicit Admins(const drogon::orm::Row &r, const ssize_t indexOffset = 0) noexcept;

    /**
     * @brief constructor
     * @param pJson The json object to construct a new instance.
     */
    explicit Admins(const Json::Value &pJson) noexcept(false);
     ...
     */
    Admins(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false);
    ...
    /**  For column pass  */
    ///Get the value of the column pass, returns the default value if the column is null
    const std::string &getValueOfPass() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getPass() const noexcept;
    ///Set the value of the column pass
    void setPass(const std::string &pPass) noexcept;
    void setPass(std::string &&pPass) noexcept;
    void setPassToNull() noexcept;
  ...
  private:
    ...
    std::shared_ptr<std::string> pass_;
    struct MetaData
    {
